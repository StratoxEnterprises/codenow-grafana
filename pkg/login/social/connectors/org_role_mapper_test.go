...
func TestOrgRoleMapper_ParseOrgMappingSettings(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			roleStrict: false,
			expected:   NewMappingConfiguration(map[string]map[string]org.RoleType{"Second": {1: org.RoleViewer}}, false),
		},
		{
		...
		},
		{
			...
			roleStrict: false,
			expected:   NewMappingConfiguration(map[string]map[string]org.RoleType{"Groups:IT:ops": {1: org.RoleViewer}}, false),
		},
		{
			...
			expected: NewMappingConfiguration(map[string]map[string]org.RoleType{"Group1": {1: org.RoleViewer}}, false),
		},
		{
		...
		},
		{
			...
			roleStrict: false,
			expected:   NewMappingConfiguration(map[string]map[string]org.RoleType{"Second": {1: org.RoleAdmin}}, false),
		},
		{
		...
		},
		{
			...
			expected: NewMappingConfiguration(map[string]map[string]org.RoleType{"ExternalOrg1": {1: org.RoleEditor}}, false),
		},
	}
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
