...
func TestOrgRoleMapper_MapOrgRoles_ReturnsDefaultOnNilMapping(t *testing.T) {
	...
	actual := mapper.MapOrgRoles(NewMappingConfiguration(map[string]map[string]org.RoleType{}, false), []string{"First"}, org.RoleNone)
...
func TestOrgRoleMapper_ParseOrgMappingSettings(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			rawMapping: []string{},
			expected:   NewMappingConfiguration(map[string]map[string]org.RoleType{}, false),
		},
		{
			name:       "should return empty mapping when role is invalid and role strict is enabled",
			rawMapping: []string{"Second:1:SuperEditor"},
			roleStrict: true,
			expected:   NewMappingConfiguration(map[string]map[string]org.RoleType{}, true),
		},
		{
			...
			roleStrict: false,
			expected:   NewMappingConfiguration(map[string]map[string]org.RoleType{"Second": {"Main Org.": org.RoleViewer}}, false),
		},
		{
		...
		},
		{
			...
			roleStrict: false,
			expected:   NewMappingConfiguration(map[string]map[string]org.RoleType{"Groups:IT:ops": {"Main Org.": org.RoleViewer}}, false),
		},
		{
			...
			expected: NewMappingConfiguration(map[string]map[string]org.RoleType{"Group1": {"Main Org.": org.RoleViewer}}, false),
		},
		{
		...
		},
		{
			...
			roleStrict: false,
			expected:   NewMappingConfiguration(map[string]map[string]org.RoleType{"Second": {"Main Org.": org.RoleAdmin}}, false),
		},
		{
		...
		},
		{
			...
			expected: NewMappingConfiguration(map[string]map[string]org.RoleType{"ExternalOrg1": {"Main Org.": org.RoleEditor}}, false),
		},
	}
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
